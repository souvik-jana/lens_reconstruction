...
class FisherMatrix:
    ...
    def compute_fisher_matrix(self, best_fit_params,key_prior):
        ...
        print('Computing Image plane Fisher matrix at best fit params:')
        ...
        # print('fisher_matrix_image_plane',fisher_matrix_image_plane)
        ...
        # print('ordered_image_plane_dict',ordered_image_plane_dict)
        # print('ordered_source_plane_dict',ordered_source_plane_dict)
        covariance_matrix_image_plane = self._compute_covariance_matrix(fisher_matrix_image_plane)
        # print('covariance_matrix_image_plane',covariance_matrix_image_plane)
        ...
        # print('fim_samples_image_plane',fim_samples_image_plane)
        # print('mean_image_plane',mean_image_plane)
        ...
        print('fisher_matrix_source_plane',fisher_matrix_source_plane)
        print('param_names_hessian_source_plane',param_names_hessian_source_plane)
        print('J',J)
    ...
    def get_jacobian_matrix(self, image_plane_ordered_keys, image_pos_flat):
        ...
        print('nparams_source',nparams_source)
        print('nparams_image',nparams_image)
